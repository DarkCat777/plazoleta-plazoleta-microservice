package com.pragma.plazoleta.dish.infrastructure.adapter.input.rest;
...
import com.pragma.plazoleta.dish.infrastructure.adapter.input.rest.response.CategoryResponse;
...
import com.pragma.plazoleta.dish.infrastructure.adapter.mapper.DishResponseMapper;
...
class DishControllerTest {
    ...
    void shouldCreateDishSuccessfully() throws Exception {
        ...
        // Configurar el usuario autenticado personalizado
        AuthenticatedUser authenticatedUser = new AuthenticatedUser(1L, "owner@email.com", List.of(RoleName.OWNER.name()));
        UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(authenticatedUser, null, List.of());
