...
public class NotPatternRule<T> implements ValidationRule<T> {
    ...
    public static final String DEFAULT_MESSAGE = "No debe coincidir con el patrón {0}.";

    public NotPatternRule(String fieldName, Function<T, String> extractor, String pattern) {
