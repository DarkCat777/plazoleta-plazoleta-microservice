...
class JwtTokenProviderAdapterTest {
    ...
    void shouldReturnDecodedJWTWhenTokenIsValid() {
        ...
        // when
        AuthenticatedUser authenticatedUser = jwtTokenProviderAdapter.getAuthenticatedUser(token);
    ...
    void shouldReturnNullWhenTokenIsInvalid() {
        ...
        // when
        AuthenticatedUser authenticatedUser = jwtTokenProviderAdapter.getAuthenticatedUser(invalidToken);
